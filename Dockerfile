...
RUN elasticsearch-plugin install "com.floragunn:search-guard-6:6.3.2-23.0"
RUN elasticsearch-plugin install https://distfiles.compuscene.net/elasticsearch/elasticsearch-prometheus-exporter-6.3.2.0.zip
