FROM blacktop/elasticsearch:6.1.0
ENV OPENSSL_JAR "netty-tcnative-openssl-1.0.2l-static-2.0.5.Final-alpine-linux-x86_64.jar"

RUN elasticsearch-plugin install "com.floragunn:search-guard-6:6.1.0-20.0"
RUN elasticsearch-plugin install https://distfiles.compuscene.net/elasticsearch/elasticsearch-prometheus-exporter-6.1.0.0.zip
