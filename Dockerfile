FROM blacktop/elasticsearch:6.2.3
ENV OPENSSL_JAR "netty-tcnative-openssl-1.0.2o-static-2.0.8.Final-alpine-linux-x86_64.jar"

RUN elasticsearch-plugin install "com.floragunn:search-guard-6:6.2.3-22.0"
RUN elasticsearch-plugin install https://distfiles.compuscene.net/elasticsearch/elasticsearch-prometheus-exporter-6.2.3.0.zip
